...
import test.com.dudhoo.nemesis.hibernate.CategoriaProdutoHomeTest;
...
import test.com.dudhoo.nemesis.hibernate.TipoContaHomeTest;
...
public class AllTests{
	...
	suite.addTestSuite(MenuRelatoriosFactoryTest.class);
        suite.addTestSuite(TipoContaHomeTest.class);
        suite.addTestSuite(CategoriaProdutoHomeTest.class);        
	return suite;
    }
