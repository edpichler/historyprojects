...
public class JPanelPessoaJuridica
	...
	if(this.pj == null){
	    ...
	    this.jTextFieldFantasia.setText(pj.getNome());
	    ...
	    if(this.pj.getPessoa() != null){
                this.jTextFieldFantasia.setText(this.pj.getPessoa().getNome());
            }else{
    ...
    public String getFantasia(){
        return jTextFieldFantasia.getText().trim();
    }
    public void setFantasia(String fat){
        jTextFieldFantasia.setText(fat);
    }
    private void limpa(){
	...
	jLabel5.setBounds(new Rectangle(15, 25, 110, 15));
