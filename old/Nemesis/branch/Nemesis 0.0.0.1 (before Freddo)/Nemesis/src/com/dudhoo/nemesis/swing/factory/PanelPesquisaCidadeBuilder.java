...
public class PanelPesquisaCidadeBuilder {
    ...
    public  PanelPesquisaGeneric getPanelPesquisarCidade(boolean criaBotaoFechar, boolean isSelectable){
        ...
        panel.setSqlQueryToFilteredRowSet("select cidade.id, cidade.nome as Cidade, estado.nome as Estado, pais.nome as País from ((" +
                " cidade INNER join estado on cidade.estado_id = estado.id)" +
