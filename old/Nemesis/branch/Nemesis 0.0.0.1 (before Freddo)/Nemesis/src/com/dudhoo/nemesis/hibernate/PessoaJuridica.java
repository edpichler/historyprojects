...
public class PessoaJuridica  implements java.io.Serializable, Fornecedor {
	...
	/** minimal constructor */
    public PessoaJuridica(long id, Pessoa pessoa, String razaoSocial, String fantasia, String cnpj, String inscricaoEstadual, String nomeCompletoContato) {
        this.id = id;
        this.pessoa = pessoa;
	...
	return getFantasia() + " - " + getRazaoSocial(); 
    }        
