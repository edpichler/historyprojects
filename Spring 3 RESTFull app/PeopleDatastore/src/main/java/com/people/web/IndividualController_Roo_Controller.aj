...
privileged aspect IndividualController_Roo_Controller {
    ...
    public String IndividualController.create(@Valid Individual individual, BindingResult result, ModelMap modelMap) {
        ...
        if (result.hasErrors()) {
            ...
            modelMap.addAttribute("sex_enum", Sex.class.getEnumConstants());
