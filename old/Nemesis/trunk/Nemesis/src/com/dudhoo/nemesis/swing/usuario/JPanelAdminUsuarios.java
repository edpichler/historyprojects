...
import com.dudhoo.nemesis.swing.usuario.event.EditUserActionAdapter;
...
public class JPanelAdminUsuarios extends JPanel{
    ...
    /**
     * Retorna o usuário selecionado no jlist
     * */
    public Usuario getUsuario(){
        return (Usuario) this.jListUsuarios.getSelectedValue();
    }
	...
	this.botaoNovoUsuario.addActionListener( new NewUserActionAdapter( this));	
        this.botaoEditarUsuario.addActionListener( new EditUserActionAdapter( this));
    }
